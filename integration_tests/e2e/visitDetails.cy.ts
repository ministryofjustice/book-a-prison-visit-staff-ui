...
context('Visit details page', () => {
  ...
  it('should show different tabs when sub navigation is used', () => {
    ...
    visitDetailsPage.eventHeader(0).contains('Needs review')
    visitDetailsPage.eventTime(0).contains('Saturday 1 January 2022 at 11am')
    visitDetailsPage.eventDescription(0).contains('Reason: Time slot removed')
    visitDetailsPage.actionedBy(1).contains('User Two')
    visitDetailsPage.eventHeader(1).contains('Updated')
    visitDetailsPage.eventTime(1).contains('Saturday 1 January 2022 at 10am')
    visitDetailsPage.eventDescription(1).contains('Method: Email request')
    visitDetailsPage.actionedBy(2).contains('User One')
    visitDetailsPage.eventHeader(2).contains('Booked')
    visitDetailsPage.eventTime(2).contains('Saturday 1 January 2022 at 9am')
    visitDetailsPage.eventDescription(2).contains('Method: GOV.UK booking')
  })
})
