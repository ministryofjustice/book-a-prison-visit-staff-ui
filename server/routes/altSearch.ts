...
export default function routes({ auditService, prisonerSearchService, visitService }: Services): Router {
  ...
  get(['/prisoner'], (req, res) => {
    ...
    res.render('pages/alt-search/prisoner', {
      search,
  ...
  post(['/prisoner'], body('search').trim('. '), (req, res) => {
    ...
    return res.redirect(
      url.format({
        pathname: `/altSearch/prisoner/results`,
        query: {
          ...(search && { search }),
        },
      }),
  ...
  get(['/prisoner/results', '/prisoner-visit/results'], async (req, res) => {
    ...
    res.render('pages/alt-search/prisonerResults', {
  ...
  get('/visit', (req, res) => {
    ...
    res.render('pages/alt-search/visit', {
      searchBlock1,
      searchBlock2,
      searchBlock3,
      searchBlock4,
      showEstablishmentSwitcher: true,
      establishmentHref: '/altSearch/visit',
    })
  })
  ...
  post('/visit', (req, res) => {
    ...
    return res.redirect(
      url.format({
        pathname: '/altSearch/visit/results',
        query: {
  ...
  get('/visit/results', async (req, res) => {
    ...
    const pageLinks = getResultsPagingLinks({
      ...
      currentPage: parsedPage,
      searchParam: `search=${search}`,
      searchUrl: '/altSearch/visit/results',
    })

    res.render('pages/alt-search/visitResults', {
      searchBlock1,
      searchBlock2,
      searchBlock3,
      searchBlock4,
