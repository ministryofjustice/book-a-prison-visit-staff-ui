...
//       visitSessionData: {
//         prisoner: { name: '', offenderNo: '', dateOfBirth: '', location: '' },
//       },
//     } as SessionData)
...
//   it.only('should redirect to the select date and time page if an adult is selected', () => {
//     const req = request(sessionApp).post('/visit/select-visitors/A1234BC')
//     req.cookies = Cookies
