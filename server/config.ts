    ...
    notificationTypes: {
      enabledRawNotifications: <NotificationTypeRaw[]>(
        get(
          ...
          'PRISONER_RECEIVED_EVENT,PRISONER_RELEASED_EVENT,PERSON_RESTRICTION_UPSERTED_EVENT,PRISON_VISITS_BLOCKED_FOR_DATE,VISITOR_RESTRICTION_UPSERTED_EVENT,VISITOR_UNAPPROVED_EVENT,PRISONER_ALERT_UPDATED_EVENT,PRISONER_ALERT_ADDED_EVENT',
        ).split(',')
      ),
    },
  },
