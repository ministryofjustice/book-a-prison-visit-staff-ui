...
describe('Prisoner visitor service', () => {
  ...
  describe('getApprovedVisitors', () => {
    ...
    it('Retrieves and processes prisoner and approved visitor details', async () => {
      ...
      const results = await prisonerVisitorsService.getApprovedVisitors(offenderNo, 'user')
  ...
  describe('getAllVisitors', () => {
    ...
    it('Retrieves and processes prisoner and all visitor details', async () => {
      const childDateOfBirth = `${new Date().getFullYear() - 4}-03-02`
      const contacts: Contact[] = [
        {
          personId: 4321,
      ...
      const results = await prisonerVisitorsService.getAllVisitors(offenderNo, 'user')
