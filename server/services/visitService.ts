...
export default class VisitService {
  ...
  async changeVisitApplication({ visitSessionData }: { visitSessionData: VisitSessionData }): Promise<ApplicationDto> {
  ...
  async getVisit({ reference, prisonId }: { reference: string; prisonId: string }): Promise<VisitInformation> {
  ...
  async getVisitDetailed({ reference }: { reference: string }): Promise<VisitBookingDetails> {
  ...
  async getBookedVisitCountByDate({ prisonId, date }: { prisonId: string; date: string }): Promise<number> {
