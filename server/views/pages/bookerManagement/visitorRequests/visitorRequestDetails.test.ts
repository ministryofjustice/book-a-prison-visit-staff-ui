...
const template = fs.readFileSync('server/views/pages/bookerManagement/visitorRequests/visitorRequestDetails.njk')

describe('Visitor Request Details', () => {
  ...
  it('should render the contact link correctly', () => {
    viewContext = { visitorRequest: TestData.visitorRequestForReview(), dpsContacts: 'dpsContacts' }
